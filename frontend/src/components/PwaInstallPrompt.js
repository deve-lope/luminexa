        ...
        <div className="p-4 sm:p-5">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm font-semibold tracking-tight text-slate-900">Install Luminexa</p>
              {showIosGuide ? (
                <p className="mt-1 text-xs leading-relaxed text-slate-600">
                  ...
                  Share, then <strong className="text-slate-800">Add to Home Screen</strong> for the
                  full app experience.
                </p>
              ) : (
                <p className="mt-1 text-xs leading-relaxed text-slate-600">
          ...
          <div className="mt-4 flex items-center gap-2">
            {canInstall && (
              <button type="button" onClick={install} className="lx-btn-primary min-h-[40px] flex-1">
                Install
              </button>
            )}
            <button
