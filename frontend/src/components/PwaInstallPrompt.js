...
import { isIosUserAgent } from '../utils/storeLinks';
...
export default function PwaInstallPrompt() {
  ...
  const ios =
    typeof navigator !== 'undefined' && isIosUserAgent(navigator.userAgent || '');
  const storeName = ios ? 'App Store' : 'Google Play';
  const ctaLabel = ios ? 'Open App Store' : 'Open Play Store';
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 text-xs leading-relaxed text-slate-600">
                Install the latest version from {storeName}. Do not add this site to your home
